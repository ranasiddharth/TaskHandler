        ...
        <Toolbar className={classes.toolbar}>
          ...
          <Hidden smDown>
            <div>
              ...
              <AddList
                getlists={props.lists}
                setGetlists={props.setLists}
    ...
    >
      <CardContent>
        ...
        >
          ...
          <div>
            <Avatar className={classes.avatar}>
              {props.list.list_name.charAt(0).toUpperCase()}
            </Avatar>
          </div>
        </div>
        ...
        <Typography variant="body1" gutterBottom>
          ...
          {moment(props.list.list_created).format(
      ...
      <CardActions className={classes.cardActions}>
        <Button
          ...
          onClick={(e) => {
            e.preventDefault();
            listDetails(proj_id, props.list.id);
          }}
        >
          Details
        </Button>
